...
extern void             USI_TWI_Master_StoreDefaultRegs();
extern void             USI_TWI_Master_ReStoreDefaultRegs();
extern void             USI_TWI_Master_Initialise( void );
extern void             USI_TWI_Master_UnInitialise( void );
...
extern unsigned char USI_TWI_Start_Transceiver_With_Data( unsigned char * , unsigned char );
extern unsigned char USI_TWI_Master_Transfer( unsigned char );
extern unsigned char USI_TWI_Master_Stop( void );
extern unsigned char USI_TWI_Master_Start( void );
